    ...
    <>
          ...
          <div className="row align-items-center g-5">
            ...
            <div className="col-12 col-lg-6">
              ...
              <h1 className="hero-title">
                Viajamos con<br /><em>propósito,</em><br />volvemos con raíces.
              </h1>
            ...
            <div className="col-12 col-lg-6 d-none d-lg-block">
              <div className="hero-img-grid">
                <img src="/img/conocenos/viajar-naturaleza-deskpot.webp" alt="Viajeros en la naturaleza" />
                <img src="/img/conocenos/naturaleza-deskpot.webp" alt="Viaje responsable" />
                <img src="/img/conocenos/bus-ecologico-deskpot.webp" alt="Transporte ecológico" />
              </div>
            </div>
            ...
            {[
              ...
              <div key={v.titulo} className="col-12 col-sm-6 col-lg-4">
                <div className="valor-card">
                  <div className="valor-icon"><i className={`bi ${v.icon}`}></i></div>
                  <h3>{v.titulo}</h3>
                  <p>{v.texto}</p>
                </div>
              </div>
          ...
          <div className="row g-5 align-items-center">
            ...
            <div className="col-12 col-lg-5">
              <div className="historia-img">
                <img src="/img/conocenos/mochila-deskpot.webp" alt="Raíces de nuestro proyecto" />
              </div>
            </div>
      ...
      <section className="cta-section">
        <div className="container cta-inner">
          ...
          <p>Únete a nuestra comunidad de viajeros conscientes y descubre destinos que te transformarán sin dañar el mundo que los hace posibles.</p>
          <a href="/provincias" className="btn-cta-blanco">Ver destinos</a>
          <a href="/registro" className="btn-cta-outline-blanco">Crear cuenta gratis</a>
        </div>
