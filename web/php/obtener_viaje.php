...
// Si el ID no viene bien, corto aquí y dejo al front pintar su estado vacío.
...
// Esta conversión final deja el detalle listo para pintarse sin más transformaciones.
$trip = [
    'id' => (int) $row['id'],
    'titulo' => $row['titulo'],
