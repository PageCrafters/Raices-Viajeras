...
(1, 'Granada', 'Paisajes de montaña, pueblos blancos y patrimonio nazarí.', NULL),
(2, 'Girona', 'Costas, senderos y patrimonio medieval en la región de Cataluña.', NULL),
(3, 'Cádiz', 'Playas, historia marinera y pueblos con encanto en el sur.', NULL),
(4, 'Asturias', 'Costa y montañas verdes, sidra y rutas naturales.', NULL),
(5, 'Lugo', 'Riqueza natural y románico en el norte de Galicia.', NULL);

INSERT INTO `viajes` (`id`, `titulo`, `descripcion`, `origen`, `fecha_inicio`, `fecha_fin`, `precio`, `plazas`, `creado_por`, `provincia_id`) VALUES
(1, 'Ruta por la Alhambra y Albaicín', 'Visita guiada a la Alhambra y paseo por el Albaicín con miradores históricos.', 'Granada', '2026-06-10', '2026-06-11', 95.00, 20, 1, 1),
...
(3, 'Paseo medieval por Girona', 'Recorrido por el barrio judío, la catedral y las murallas con guía local.', 'Girona', '2026-05-20', '2026-05-20', 45.00, 25, 1, 2),
...
(1, 'Feria internacional FITUR y turismo sostenible', 'La feria internacional de turismo FITUR 2026, celebrada en Madrid, reunió a gobiernos, empresas y expertos para debatir el futuro del turismo. Uno de los temas principales fue impulsar un modelo turístico más sostenible. Durante el evento se propusieron medidas como reducir el impacto ambiental del transporte, promover alojamientos ecológicos y evitar la masificación de destinos turísticos. La feria contó con más de 255000 visitantes y generó un impacto económico de unos 505 millones de euros, lo que demuestra su importancia para el sector turístico internacional.', 'Turismo', 'energiaybiodibersidad.webp'),
...
(3, 'Nuevos destinos de ecoturismo en África', 'En África también están surgiendo nuevos destinos que apuestan por el turismo sostenible. Las Malawi Highlands, una región montañosa del sureste de África, se están posicionando como destino internacional de aventura y ecoturismo. Los proyectos turísticos de la región buscan conservar ecosistemas naturales, apoyar a las comunidades locales y promover actividades de bajo impacto ambiental. Entre las actividades más populares destacan el senderismo en reservas naturales, el turismo comunitario, la observación de fauna y los programas de conservación ambiental.', 'Turismo', 'malawi.webp');
