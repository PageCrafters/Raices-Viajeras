...
selenium.open("http://localhost:63342/Raices-Viajeras/web/index.html?_ijt=r1m02hjr480heg1ugcnh12ijqe&_ij_reload=RELOAD_ON_SAVE#")
selenium.click("id=nombre")
selenium.type("id=nombre", "Ana")
selenium.click("id=correo")
selenium.click("id=correo")
selenium.type("id=correo", "")
selenium.click("id=tit-form")
selenium.type("id=nombre", ("Ana López").toString())
selenium.click("id=correo")
selenium.click("id=correo")
selenium.type("id=correo", "ana")
selenium.click("id=error-correo")
selenium.click("id=correo")
selenium.type("id=correo", ("analopezkrece@gmail.com").toString())
selenium.click("xpath=//section[@id='formulario']/div[2]/div")
